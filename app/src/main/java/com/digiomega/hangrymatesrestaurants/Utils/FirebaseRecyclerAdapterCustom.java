...
public abstract class FirebaseRecyclerAdapterCustom<T, VH extends RecyclerView.ViewHolder>
     ...
     */
    public FirebaseRecyclerAdapterCustom(FirebaseRecyclerOptions<T> options, boolean isFiltarable) {
