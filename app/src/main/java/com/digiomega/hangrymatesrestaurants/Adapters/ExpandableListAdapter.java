...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		holder.menu_item_extra_tv.setText(childTerbaru.getQuantity().replaceAll("&amp;", "&")+"x "+childTerbaru.getExtra_item_name().replaceAll("&amp;", "&")+" +"+childTerbaru.getCurrency()+childTerbaru.getPrice().replaceAll("&amp;", "&"));
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		holder.menu_item_name_tv.setText(terbaruModel.getItem_name().replaceAll("&amp;", "&")+" x "+terbaruModel.getOrder_quantity().replaceAll("&amp;", "&"));
